...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    const logoText = Center(
        child: Text('QuickTouch',style: TextStyle(
          fontSize: 25,
    ...
    final registerButton = Padding(
      ...
      child: ElevatedButton(
        ...
        // style: ElevatedButton.styleFrom(backgroundColor: Color.fromRGBO(160, 145, 125, 1)),
        // style: ElevatedButton.styleFrom(backgroundColor: Color.fromRGBO(139, 94, 131, 1)),
        style: ElevatedButton.styleFrom(backgroundColor: Colors.deepPurple),
